...
//     let targetObj = houses.find(item => item.name == targetHouse).content
//     let houseDB = Object.values(targetObj)
//                         .map(x=> {
//                             let className = x.split(":")[0];
//                             let createDiv = document.createElement("div");
//                             createDiv.textContent = x;
//                             createDiv.setAttribute('class', className)
//                             return createDiv.outerHTML
//                         })
//                         .join("");

// document.getElementById("content").innerHTML = houseDB;
...
// ------------------------------------------------Variant 3 (dont working)----------------------------

    // const targetHouse = event.target.textContent;
    // var houseDB = houses.find(item => item.name == targetHouse).content;
    // console.log(houseDB);
    // Object.keys(houseDB).forEach(function(key) {
    //     if(key == "house") {
    //         document.getElementById("content").innerHTML += openH1 + this[key] + closeH1;
    //     } else {
    //         document.getElementById("content").innerHTML += openDiv + this[key] + closeDiv;
    //     }
    //   }, houseDB);
...
// ------------------------------------------------Variant 4 ----------------------------
    ...
    // const targetHouse = event.target.textContent;
    // const openDiv = '<div class="content__block">';
    // const closeDiv = '</div>';
    // const openH1 = '<h1 class="content__block">';
    // const closeH1 = '</h1>';
    // let houseDB = houses.find(item => item.name == targetHouse).content;
    // let content =     openH1 + houseDB.house + closeH1
    //                 + openDiv + houseDB.img + closeDiv
    //                 + openDiv + houseDB.sigil + closeDiv
    //                 + openDiv + houseDB.words + closeDiv
    //                 + openDiv + houseDB.titles + closeDiv
    //                 + openDiv + houseDB.seat + closeDiv
    //                 + openDiv + houseDB.region + closeDiv
    //                 + openDiv + houseDB.head + closeDiv
    //                 + openDiv + houseDB.founded + closeDiv
    //                 + openDiv + houseDB.about + closeDiv
    //                 + openDiv + houseDB.history + closeDiv
    // console.log(content)
