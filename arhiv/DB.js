const houses = [
    ...
    },
    {
        ...
        content:{
            house: "Баратеони",
            sigil: "Чорний коронований олень, що стоїть на задніх ногах, на золотому полі",
            words: "Нам — лють",
            titles: "Верховні Володарі Штормових Земель",
            seat: "Штормова Межа",
            region: "Штормові землі",
            head: "Роберт Баратеон",
            founded: "Томмен Баратеон",
            about: "Баратеони — один з великих домів Вестероса, і наймолодший з них.",
            history: "Родоначальником дому є Оріс Баратеон, який був воєначальником у Ейгона Завойовника. Ходили чутки, що Оріс є бастардом і зведеним братом Ейгона. Оріс вбив останнього короля Штормового Межі, Аргилака Гордовитого, і зайняв замок. Його доньку, Аргеллу, він взяв у дружини." 
        },
    },
    {
        name: "Старки",
    ...
    },
    {
        ...
        content:{
            house: "Грейджої",
            sigil: "Золотий кракен на чорному тлі",
            words: "Ми не сіємо",
            titles: "Лорди Залізних островів",
            seat: "Пайк",
            region: "Залізні острови",
            head: "Бейлон Грейджой",
            founded: "Сірий Король",
            about: "Грейджої (ориг. House Greyjoy ) - один з великих будинків Вестероса . Управляють Залізними островами із замку Пайк . Символ цього будинку – золотий кракен на чорному тлі, а їхній девіз – «Ми не сіємо».",
            history: "Будинок Грейджоїв походить від Сірого Короля , легендарного Короля Залізних островів. Згідно з повір'ями, він правив тисячу років і взяв за дружину русалку. Як і більшість залізничних , вони вірять у Бога , що потонув .На момент початку Війни п'яти королів на чолі будинку був Бейлон Грейджой . За вісім років до подій Війни п'яти королів він підняв повстання проти влади Залізного трону . Повстання закінчилося для Бейлона поразкою, двоє його синів, Родрік і Марон , загинули. Третього сина, Теона , взяв у заручники Еддард Старк , його відвезли у замок Вінтерфелл , де виховувався і навчався разом із дітьми Старка. Поруч із Бейлоном залишилася лише дочка Яра ." 
        },
    },
    {
        name: "Тірели",
